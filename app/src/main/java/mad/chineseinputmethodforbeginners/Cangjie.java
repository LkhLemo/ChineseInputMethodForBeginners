...
public class Cangjie extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cangjie);
        ...
        click.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if (word.equals(QCangjile.answer[currentquestionindex])){
                    news = news + 1;
        ...
        question.setText(QCangjile.question[currentquestionindex]);
    }
